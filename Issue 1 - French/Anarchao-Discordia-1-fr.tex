...
\include{./anarchism_and_crime-fr}

\include{./coalitions_and_separation_of_powers-fr}

\include{./not_an_anarchist-fr}

\include{./rise_of_insignificance-fr}

\include{./manifesto-fr}
